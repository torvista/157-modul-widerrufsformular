 ...
 */
?>
	<link rel="stylesheet" type="text/css" media="all" href="<?php echo $template->get_template_dir('widerrufsformular.css', DIR_WS_TEMPLATE, 'css', 'css') . '/widerrufsformular.css'; ?>">
