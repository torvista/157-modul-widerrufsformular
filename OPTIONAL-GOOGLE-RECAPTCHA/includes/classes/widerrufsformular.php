...
* @version $Id: widerrufsformular.php for Google Recaptcha V3 2026-03-09 21:37:40Z webchills $
*/
class widerrufsformular extends base{
	...
	private function CompileJsonFromPostedValues(){
		$message = array();
		$ignore_list = array('securityToken', 'action', 'form_id', 'g-recaptcha-response');
